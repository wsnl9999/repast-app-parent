...
public class PmsProduct {
    ...
    /**
     * 0:外卖商品   1堂食商品（可以点餐可以外卖）
     */
    @Column(name = "roduct_category")
    private Integer roductCategory;
    ...
    /**
     * 获取0:外卖商品   1堂食商品（可以点餐可以外卖）
     *
     * @return roduct_category - 0:外卖商品   1堂食商品（可以点餐可以外卖）
     */
    public Integer getRoductCategory() {
        return roductCategory;
    }

    /**
     * 设置0:外卖商品   1堂食商品（可以点餐可以外卖）
     *
     * @param roductCategory 0:外卖商品   1堂食商品（可以点餐可以外卖）
     */
    public void setRoductCategory(Integer roductCategory) {
        this.roductCategory = roductCategory;
    }
